...
public class JacalEntity extends HostileEntity {
    private static final float SPEED = 0.3f;
    private static final double ATTACK_DAMAGE = 6.0;
    private static final int ATTACK_SPEED = 20;

    public JacalEntity(EntityType<? extends JacalEntity> type, World world) {
        super(type, world);
    }
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(net.minecraft.entity.attribute.EntityAttributes.MAX_HEALTH).setBaseValue(20.0);
